                    ...
                    <div class="col-6 col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('teacher_type') is-invalid @enderror"
                                ...
                                <option {{old('teacher_type') == 'teacher' ? 'selected' : '' }} value="teacher">معلمة</option>
                                <option {{old('teacher_type') == 'assistant' ? 'selected' : '' }} value="assistant">مساعدة</option>
                                <option {{old('teacher_type') == 'worker' ? 'selected' : '' }} value="worker">موظف</option>
                            </select>
                            @error('teacher_type')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
