                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" id="birth_date" name="birth_date"
                                               ...
                                               value="@if(old('birth_date')) {{date('d/m/Y', strtotime(old('birth_date'))) }} @endif"
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select @error('school_class_id') is-invalid @enderror"
                                            ...
                                            @foreach($schools as $school)
                                                <option {{old('school_class_id') ==  $school->id ? 'selected' : '' }} value="{{ $school->id }}">
                                                    {{$school->name}} -    {{$school->address}}
                                                </option>
                                            @endforeach
                                        </select>
                                        <label for="school_class_id" class="form-label"> الفرع المراد التسجيه به </label>
