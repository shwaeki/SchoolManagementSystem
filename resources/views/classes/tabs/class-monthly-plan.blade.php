...
@php($monthlySubjects = [ "التنوير اللغوي", "العلوم", "التفكير الرياضي", "الحسي الحركي", "اللغة الانجليزية"])
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        <div class="card">
                                            <div class="card-header py-2 bg-transparent d-flex justify-content-between">
                                                ...
                                                <div class="d-print-none">
                                                    <button type="button"
                                                            ...
                                                            class="btn btn-light-warning text-warning rounded-circle ednitMonthlyPlan">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p> {!! $monthlyPlans[$key][0]['objectives'] !!}</p>
                                                <hr>
                                                <p class="mb-1 fw-bold fs-6">الوسائل:</p>
                                                <p>{!! $monthlyPlans[$key][0]['methods'] !!}</p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="editMonthPlanObjectives" name="objectives" class="form-control"
                                      rows="3"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="editMonthPlanMethods">الوسائل </label>
                            <textarea id="editMonthPlanMethods" name="methods" class="form-control" rows="3"></textarea>
                        </div>
...
@push("scripts")
    <script>
        ...
        $(document).on("click", ".ednitMonthlyPlan", function () {
            var id = $(this).data("id");
