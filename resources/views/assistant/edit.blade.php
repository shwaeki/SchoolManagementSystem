        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>تعديل معلومات المساعدة - {{$teacher->name}}</h4>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area-normal">
            <form action="{{ route('assistants.update',['assistant'=>$teacher]) }}" method="POST">
                @method('PUT')
                @csrf
...
{{--                    <div class="col-6 col-md-3">
    ...
    <div class="statbox widget box box-shadow mt-3">
        ...
        <div class="widget-content widget-content-area-normal">
            <form action="{{route('assistants.password',$teacher)}}" method="POST">
                @method('PUT')
                @csrf
                <div class="row">
