        ...
        <div class="widget-content widget-content-area-normal">
            <form action="{{ route('assistants.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="mb-3">
                            <label for="status" class="form-label"> حالة المساعدة </label>
                            <select class="form-select @error('status') is-invalid @enderror"
                                ...
                                <option
                                    {{old('status') == 'maternity_leave' ? 'selected' : '' }} value="maternity_leave">
                                    اجازة ولادة
                                </option>
                                <option
                                    {{old('status') == 'unpaid_vacation' ? 'selected' : '' }} value="unpaid_vacation">
                                    اجازة بدون راتب
                                </option>
                                ...
                                <option
                                    {{old('status') == 'substitute_teacher' ? 'selected' : '' }} value="substitute_teacher">
                                    معلم بديل
                                </option>
