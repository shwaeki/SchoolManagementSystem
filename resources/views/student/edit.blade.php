                    ...
                    <div class="col-6 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="mother_phone" name="mother_phone"
                                   ...
                                   value="{{old('mother_phone',$student->mother_phone)}}" maxlength="10" required>
                            @error('mother_phone')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="mother_id" name="mother_id"
                                   ...
                                   value="{{old('mother_id',$student->mother_id)}}" required>
                            @error('mother_id')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="father_phone" name="father_phone"
                                   ...
                                   value="{{old('father_phone',$student->father_phone)}}" maxlength="10" required>
                            @error('father_phone')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
