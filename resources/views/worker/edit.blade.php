...
@section('content')
        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>تعديل معلومات الموظف - {{$worker->name}}</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="identification" name="identification"
                                   ...
                                   maxlength="9" value="{{old('identification',$worker->identification)}}" required>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="birth_date" name="birth_date"
                                   ...
                                   value="{{ date('d/m/Y', strtotime(old('birth_date',$worker->birth_date))) }}" required>
                            @error('birth_date')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="address" name="address"
                                   ...
                                   value="{{old('address',$worker->address)}}" required>
                            @error('address')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="bank_name" name="bank_name"
                                   ...
                                   value="{{old('bank_name',$worker->bank_name)}}">
                            @error('bank_name')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="bank_branch" name="bank_branch"
                                   ...
                                   value="{{old('bank_branch',$worker->bank_branch)}}">
                            @error('bank_branch')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="bank_account" name="bank_account"
                                   ...
                                   value="{{old('bank_account',$worker->bank_account)}}">
                            @error('bank_account')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" id="phone" name="phone"
                                   ...
                                   value="{{old('phone',$worker->phone)}}" required>
                            @error('phone')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" id="phone_2" name="phone_2"
                                   ...
                                   value="{{old('phone_2',$worker->phone_2)}}">
                            @error('phone_2')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" id="star_work_date" name="star_work_date"
                                   ...
                                   value="{{ date('d/m/Y', strtotime(old('star_work_date',$worker->star_work_date))) }}"  required>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('gender') is-invalid @enderror"
                                ...
                                <option {{old('gender',$worker->gender) == 'male' ? 'selected' : '' }} value="male">
                                    ذكر
                                </option>
                                <option
                                    {{old('gender',$worker->gender) == 'female' ? 'selected' : '' }} value="female">
                                    انثى
                                </option>
                            </select>
                            @error('gender')
                    ...
                    <div class="col-6 col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('job_type') is-invalid @enderror"
                                ...
                                <option selected disabled value="">اختر ...</option>
                                <option
                                    {{old('job_type',$worker->job_type) == 'fullJob' ? 'selected' : '' }} value="fullJob">
                                    وظيفة كاملة
                                </option>
                                <option
                                    {{old('job_type',$worker->job_type) == 'partTime' ? 'selected' : '' }} value="partTime">
                                    وظيفة جزئية
                                </option>
                            </select>
                            @error('job_type')
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="notes" name="notes"
                                      ...
                                      rows="3">{{old('notes',$worker->notes)}}</textarea>
                            @error('notes')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
    ...
    <div class="statbox widget box box-shadow mt-3">
        ...
        <div class="widget-content widget-content-area-normal">
            <form action="{{route('workers.password',$worker)}}" method="POST">
                @method('PUT')
                @csrf
                <div class="row">
