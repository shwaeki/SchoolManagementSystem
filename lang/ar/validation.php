...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'code'                  => 'الكود',
        'capacity'              => 'الطاقة الاستيعابة',
        'alphabetical_name'     => 'الكود الابجدي',
        'student_start_age'     => 'الحد الادنى لعمر الطلاب',
        'student_end_age'       => 'الحد الاعلى لعمر الطلاب',
        'identification'        => 'رقم الهوية',
        'star_work_date'        => 'تاريخ بدأ العمل',
        'phone_1'               => 'رقم الهاتف',
        'phone_2'               => 'رقم الهاتف الاحتياطي',
        'notes'                 => 'الملاحظات',
        'birth_place'           => 'مكان الولادة',
        'family_status'         => 'الحالة الاجتماعية للعائلة',
        'mother_name'           => 'اسم الام',
        'mother_phone'          => 'رقم هاتف الام',
        'father_name'           => 'اسم الاب',
        'father_phone'          => 'رقم هاتف الاب',
        'custody'               => 'حضانة الطالب',
        'family_members'        => 'الشارع',
        'mother_id'             => 'رقم هوية الام',
        'father_id'             => 'رقهم هوية الاب',
        'postal_code'           => 'رقم صندوق البريد',
